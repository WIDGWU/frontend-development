export const colleges: { [key: string]: {name: string, aliases: string[]} } = {
  ...
  MISPH: {name: 'MISPH',aliases:["MISPH", "GWSPH", "Milken Inst Sch of Public Hlth"]},
  SON: {name: 'SON',aliases:["SON", "School of Nursing"]},
  CPS: {name: 'CPS',aliases:["CPS", "Coll of Professional Studies"]},
  GSEHD: {name: 'GSEHD',aliases:["GSEHD", "GSHED", "Grad Sch of Ed and Human Devel"]},
  SMHS: {name: 'SMHS',aliases:["SMHS", "HCL", "HSCI", "MLS", "School of Med & Health Sc"]},
  NA: {name: 'No College Designated',aliases:["NA","NSC", "No College Designated"]},
};
